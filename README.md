...
1. INTRODUCTION:
  ...
  C. 3.2", 3.5" and 4.3" Nextion display enclosures for Raspberry Pico are coming soon
...
3. HARDWARE REQUIREMENTS for version A:
  ...
  The LED's power is common anode; the LED cathodes need a 1 to 10k 1/8W resistor before connection to their respective negative supply poles.
